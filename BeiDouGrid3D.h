...
#include <vector>
#include "D:\Users\Administrator\Desktop\PostgreSQL\PositioningGrid\PositioningGrid.h"
...
namespace Grid
{
    ...
    public:
        ...
        /**
            #include <cstdint> // Add this include at the top of the file to define int32
        ...
        int32 GetLevelByCode3d (const std::string_view& code3d) const { return GetLevelByCode3D(code3d); }
